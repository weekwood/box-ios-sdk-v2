...
7. Create a build phase to copy the compiled framework into a 'Frameworks' directory in your application bundle.<br />![Copy to bundle](http://box.github.io/box-ios-sdk-v2/readme-images/cocoa-copy-to-bundle.png)
