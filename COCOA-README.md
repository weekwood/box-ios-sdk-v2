...
4. Add the BoxCocoaSDK target as a target dependency.<br />![Target dependency](readme-images/cocoa-target-dependency.png)

5. Link with BoxCocoaSDK.framework<br />![Link with binary](readme-images/cocoa-link-with-binary.png)
...
7. Create a build phase to copy the compiled framework into a 'Frameworks' directory in your application bundle.<br />![Copy to bundle](readme-images/cocoa-copy-to-bundle.png)
