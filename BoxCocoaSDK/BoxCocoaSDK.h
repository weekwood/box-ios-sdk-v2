 ...
 *
 * Access to this class and all other components of the BoxSDK can be granted by including `<BoxCocoaSDK/BoxCocoaSDK.h>`
 * in your source code.
 *
...
/* Folder picker is currently iOS dependent */
